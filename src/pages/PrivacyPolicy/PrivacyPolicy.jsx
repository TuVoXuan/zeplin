...
export default function PrivacyPolicy() {
  return (
    <div className={clsx("container", styles["privacy-policy-wrap"])}>
      <h1 className={styles["privacy-policy-wrap__title"]}>
        priavacy & policy
      </h1>

      <div className={styles["privacy-policy-wrap__content"]}>
        <p>제1조(목적)</p>
        <p>
          이 약관은 00 회사(전자상거래 사업자)가 운영하는 00 사이버 몰(이하
          "몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 서비스라 한다)를
          이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항 규정함을
          목적으로 합니다.
        </p>
        <br />
        <p>
          ※TPC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지
          않는 한 이 약관을 준용합니다」
        </p>
        <br />
        <p>제2조(정의)</p>
        <p>
          ①"몰" 이란 00 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게
